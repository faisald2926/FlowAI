...
const LeakAlert: React.FC<LeakAlertProps> = ({ hasLeak }) => {
  if (!hasLeak) {
    return null;
  }

  return (
    <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 p-6 rounded-lg shadow-lg flex items-center">
